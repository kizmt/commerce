                      ...
                      >
                        <div className="relative flex w-full flex-row justify-between px-1 py-4">
                          ...
                          <div className="flex flex-row">
                            <div className="relative h-16 w-30 overflow-hidden rounded-md border border-border bg-muted">
                              <Image
...
function CloseCart({ className }: { className?: string }) {
  return (
    <div className="relative flex h-11 w-11 items-center justify-center rounded-md border border-border text-foreground transition-colors hover:bg-muted">
      <XMarkIcon
        className={clsx(
...
function CheckoutButton() {
  ...
  return (
    <button
      className="block w-full rounded-sm bg-primary p-3 text-center text-sm font-medium text-primary-foreground opacity-90 hover:opacity-100"
      type="submit"
      disabled={pending}
    >
      {pending ? (
